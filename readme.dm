...
![Alt text](https://github.com/jcn13/project_2/blob/master/boothgames.jpg)
...
Code for the buzz wire game made with an arduino board and js.

surge address: booth-games.surge.sh
